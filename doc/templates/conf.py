...
exclude_patterns = ['base/templates', 'base/media']
...
htmlhelp_basename = 'scdetect_doc'
...
latex_documents = [
    ('index', 'scdetect.tex', u'SCDetect Documentation',
     u'SED', 'manual'),
]
...
.. |appname| replace:: `scdetect-cc`
.. |sed| replace:: `SED`
.. |beer| unicode:: U+1F37A .. BEER
"""
