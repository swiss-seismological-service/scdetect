#ifndef SCDETECT_APPS_SCDETECT_PROCESSING_DETAIL_GAPINTERPOLATE_H_
#define SCDETECT_APPS_SCDETECT_PROCESSING_DETAIL_GAPINTERPOLATE_H_
...
#endif  // SCDETECT_APPS_SCDETECT_PROCESSING_DETAIL_GAPINTERPOLATE_H_
