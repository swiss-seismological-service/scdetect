#ifndef SCDETECT_APPS_CC_REDUCINGAMPLITUDEPROCESSOR_H_
#define SCDETECT_APPS_CC_REDUCINGAMPLITUDEPROCESSOR_H_
...
#endif  // SCDETECT_APPS_CC_REDUCINGAMPLITUDEPROCESSOR_H_
