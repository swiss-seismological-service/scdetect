#ifndef SCDETECT_APPS_CC_DETECTOR_DETECTORWAVEFORMPROCESSOR_H_
#define SCDETECT_APPS_CC_DETECTOR_DETECTORWAVEFORMPROCESSOR_H_
...
#endif  // SCDETECT_APPS_CC_DETECTOR_DETECTORWAVEFORMPROCESSOR_H_
