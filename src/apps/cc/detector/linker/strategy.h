#ifndef SCDETECT_APPS_CC_DETECTOR_LINKER_STRATEGY_H_
#define SCDETECT_APPS_CC_DETECTOR_LINKER_STRATEGY_H_
...
#endif  // SCDETECT_APPS_CC_DETECTOR_LINKER_STRATEGY_H_
