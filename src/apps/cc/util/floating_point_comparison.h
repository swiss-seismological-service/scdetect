#ifndef SCDETECT_APPS_CC_UTIL_FLOATINGPOINTCOMPARISON_H_
#define SCDETECT_APPS_CC_UTIL_FLOATINGPOINTCOMPARISON_H_
...
#endif  // SCDETECT_APPS_CC_UTIL_FLOATINGPOINTCOMPARISON_H_
